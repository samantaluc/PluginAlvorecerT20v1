...
local function constructNew_frmPoderesMagias()
    ...
    obj.label1:setText("Dar ENTER nas descrições e titulos para salvar. Legenda: [P] Poderes, [D] Domínio, [T] Talentos, [M] Magias");
    obj.label1:setName("label1");

    obj.button1 = GUI.fromHandle(_obj_newObject("button"));
    obj.button1:setParent(obj.scrollBox2);
    obj.button1:setText("Criar Novo Poder/Magia/Talento");
    obj.button1:setWidth(300);
    obj.button1:setAlign("left");
    obj.button1:setName("button1");

    obj.rcllistaMagias = GUI.fromHandle(_obj_newObject("recordList"));
    obj.rcllistaMagias:setParent(obj.scrollBox1);
    ...
    obj.boxDestalhesDaMagia:setParent(obj.scrollBox1);
    ...
    obj._e_event1 = obj.rcllistaMagias:addEventListener("onSelect",
        function (_)
            --[[
    ...
    obj._e_event2 = obj.rcllistaMagias:addEventListener("onCompare",
...
function newfrmPoderesMagias()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmPoderesMagias();
      end,
      function()
...
local _frmPoderesMagias = {
    newEditor = newfrmPoderesMagias, 
    new = newfrmPoderesMagias, 
    name = "frmPoderesMagias", 
    dataType = "", 
    formType = "undefined", 
...
frmPoderesMagias = _frmPoderesMagias;
Firecast.registrarForm(_frmPoderesMagias);

return _frmPoderesMagias;
